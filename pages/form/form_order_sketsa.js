        ...
        <div className="form_putih">
            ...
            <table align="center">
                    <tr>
                        <td>Name</td>
                        <td>:</td>
                        <td><input type="text" placeholder="Name" value="Septiany"/></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
                        <td><input type="text" placeholder="Email" value="septiany@gmail.com"/></td>
                    </tr>
                    <tr>
                        <td>Phone Number</td>
                        <td>:</td>
                        ...
                        <div className="dress_choice">
                            <div>
                                ...
                                <div className="keterangan_order">
                                    ...
                                    <p className="nama_desaigner">Luna Alister</p>
                                </div>
                            </div>
                        </div>
                        <div className="div_button_proses_cancel">
                           <a  href="/form/form_payment_sketsa"className="a_button_proses_form_order">Process</a>
                        </div>
                        <div className="div_button_proses_cancel">
